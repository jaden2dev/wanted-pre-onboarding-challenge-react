...
## chatper 3
https://github.com/jaden2dev/wanted-pre-onboarding-challenge-react/tree/feat/chapter3
...
## chapter 5
https://github.com/jaden2dev/wanted-pre-onboarding-challenge-react/tree/feat/chapter5

Navigating Between Pages

a -> Link component로 변경
...
- usePathname() 훅을 이용하용 active tab 표시하기
/app/ui/dashboard/nav-links.tsx
```
'use client';
